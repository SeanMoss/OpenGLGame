...
bool OBJLoader::LoadModel(const char* path, std::vector<unsigned short>& out_indices, std::vector<glm::vec3>& out_vertices, std::vector<glm::vec2>& out_uvs, std::vector<glm::vec3>& out_normals, unsigned int* numFaces)
{
	...
	// Fill face indices, ONLY WORKS FOR TRIANGLES
